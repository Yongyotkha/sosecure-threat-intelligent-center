var frappe = function () {
    ...
    function b(t, e) {
        ...
        var a = function (t, e) {
                var i = e[0] - t[0],
                    n = e[1] - t[1];
                return {
                    length: Math.sqrt(Math.pow(i, 2) + Math.pow(n, 2)),
    ...
    function P(t, e) {
        ...
        for (var n in e) {
            var a = e[n];
            if ("inside" === n) A(a).appendChild(i);
            else if ("around" === n) {
                var s = A(a);
                s.parentNode.insertBefore(i, s), i.appendChild(s)
            } else "styles" === n ? "object" === (void 0 === a ? "undefined" : Wt(a)) && Object.keys(a).map(function (t) {
                i.style[t] = a[t]
    ...
    function z(t, e) {
        var i = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
            ...
            a = L(t, n),
            s = [1, .6, .2];
        return i && (s = [.4, .2, 0]), T(a, "0%", e, s[0]), T(a, "50%", e, s[1]), T(a, "100%", e, s[2]), n
    }

    function W(t, e, i, n) {
        var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : qt,
    ...
    function F(t, e, i) {
        var n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : "none",
            a = arguments[4];
        a = arguments.length > 5 && void 0 !== arguments[5] && arguments[5] ? y(a, ne) : a;
        var s = {
        ...
        return o.appendChild(P("rect", s)), o.appendChild(r), o
    }
    ...
    function j(t, e, i) {
        ...
        return o.appendChild(P("circle", s)), o.appendChild(r), o
    }
    ...
    function Y(t, e, i, n) {
        var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : {};
        a.stroke || (a.stroke = se), a.lineType || (a.lineType = ""), a.shortenNumbers && (e = m(e));
        var s = P("line", {
    ...
    function B(t, e, i) {
        var n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {};
        f(t) || (t = 0), n.pos || (n.pos = "left"), n.offset || (n.offset = 0), n.mode || (n.mode = "span"), n.stroke || (n.stroke = se), n.className || (n.className = "");
        var a = -1 * ee,
            s = "span" === n.mode ? i + ee : 0;
        return "tick" === n.mode && "right" === n.pos && (a = i + ee, s = i), a += n.offset, s += n.offset, Y(t, e, a, s, {
            stroke: n.stroke,
    ...
    function V(t, e, i) {
        var n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {};
        f(t) || (t = 0), n.pos || (n.pos = "bottom"), n.offset || (n.offset = 0), n.mode || (n.mode = "span"), n.stroke || (n.stroke = se), n.className || (n.className = "");
        var a = i + ee,
            s = "span" === n.mode ? -1 * ee : i;
        return "tick" === n.mode && "top" === n.pos && (a = -1 * ee, s = 0), R(t, e, a, s, {
            stroke: n.stroke,
            className: n.className,
            lineType: n.lineType
        })
    ...
    function U(t, e, i) {
        ...
        var a = P("text", {
                ...
                x: "left" === n.labelPos ? ie : i - d(e, 5) - ie,
                y: 0,
                dy: ae / -2 + "px",
                "font-size": ae + "px",
                "text-anchor": "start",
    ...
    function G(t, e, i, n) {
        ...
        var o = P("text", {
                className: "chart-label",
                x: "left" === a.labelPos ? ie : i - d(n + "", 4.5) - ie,
                y: 0,
                dy: ae / -2 + "px",
                "font-size": ae + "px",
                "text-anchor": "start",
    ...
    function q(t, e, i, n) {
        var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : "",
            ...
            h = u[0],
            c = u[1];
        c -= r, 0 === h && (h = o.minHeight, c -= o.minHeight), f(t) || (t = 0), f(c) || (c = 0), f(h, !0) || (h = 0), f(i, !0) || (i = 0);
        var d = P("rect", {
            className: "bar mini",
            style: "fill: " + n,
            "data-point-index": s,
        ...
        if ((a += "") || a.length) {
            ...
            return g.appendChild(d), g.appendChild(p), g
        }
        return d
    }
    ...
    function J(t, e, i) {
        ...
        if (n.regionFill) {
            var u = z(a.svgDefs, i, !0),
                h = "M" + t[0] + "," + a.zeroLine + "L" + s + "L" + t.slice(-1)[0] + "," + a.zeroLine;
            l.region = D(h, "region-fill", "none", "url(#" + u + ")")
        }
        return l
    }
    ...
    function $(t, e, i) {
        return K(t, [i, 0], [e, 0], ce)
    }

    function Q(t, e, i) {
        return K(t, [0, i], [0, e], ce)
    }
    ...
    function Z(t, e, i, n) {
        ...
        return [
            ...
            }, ce, pe], K(t, [0, n], [0, i], ce)
        ]
    }

    function tt(t, e, i, n) {
        var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 0,
            s = v(i, (arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : {}).zeroLine),
            r = Yt(s, 2),
            o = r[0],
            l = r[1];
        return l -= a, "rect" !== t.nodeName ? [
            [t.childNodes[0], {
                width: n,
                height: o
            }, ue, pe], K(t, t.getAttribute("transform").split("(")[1].slice(0, -1), [e, l], ce)
        ] : [
            [t, {
                width: n,
                height: o,
    ...
    function et(t, e, i) {
        return "circle" !== t.nodeName ? [K(t, t.getAttribute("transform").split("(")[1].slice(0, -1), [e, i], ce)] : [
            [t, {
                cx: e,
                cy: i
            }, ue, pe]
    ...
    function xt(t, e, i) {
        var n = Object.keys(Pe).filter(function (e) {
                return t.includes(e)
            }),
            a = Pe[n[0]];
    ...
    function Pt(t) {
        function e(t, e) {
            for (var i = At(t), n = i[1] - i[0], a = 0, s = 1; a < e; s++) a += n, i.unshift(-1 * a);
            return i
        }
        var i = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
            n = Math.max.apply(Math, Bt(t)),
            a = Math.min.apply(Math, Bt(t)),
            s = [];
        if (n >= 0 && a >= 0) kt(n)[1], s = i ? At(n, a) : At(n);
        else if (n > 0 && a < 0) {
            var r = Math.abs(a);
            n >= r ? (kt(n)[1], s = e(n, r)) : (kt(r)[1], s = e(r, n).map(function (t) {
                return -1 * t
            }))
        } else if (n <= 0 && a <= 0) {
            var o = Math.abs(a),
                l = Math.abs(n);
            kt(o)[1], s = (s = i ? At(o, l) : At(o)).reverse().map(function (t) {
                return -1 * t
            })
        }
        return s
    ...
    function Ct(t, e) {
        return h(e.zeroLine - t * e.scaleMultiplier)
    }
    ...
    function Dt(t, e) {
        for (var i = Math.max.apply(Math, Bt(t)), n = 1 / (e - 1), a = [], s = 0; s < e; s++) {
            var r = i * (n * s);
            a.push(r)
        }
        return a
        ...
        return n || (n = [{
            ...
            if (t.values) {
                ...
                n = (n = n.map(function (t) {
                    return isNaN(t) ? 0 : t
                })).length > i ? n.slice(0, i) : c(n, i - n.length, 0)
            } else t.values = a;
            t.chartType || (Gt.includes(e), t.chartType = e)
    ...
    function _t(t) {
        ...
        var a = n / Xt,
            s = void 0;
        if (i) {
            var r = Math.max.apply(Math, Bt(e.map(function (t) {
                return t.length
            })));
            s = Math.ceil(r / a)
        }
        return e.map(function (t, e) {
            return (t += "").length > a && (i ? e % s != 0 && (t = "") : t = a - 3 > 0 ? t.slice(0, a - 3) + " ..." : t.slice(0, a) + ".."), t
        })
    }
    ...
    function zt() {
        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "line",
            e = arguments[1],
            i = arguments[2];
        return "axis-mixed" === t ? (i.type = "line", new Ce(e, i)) : De[t] ? new De[t](e, i) : void console.error("Undefined chart type: " + t)
    }! function (t, e) {
        void 0 === e && (e = {});
        var i = e.insertAt;
    ...
    var Wt = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
            return typeof t
        } : function (t) {
    ...
    t.create = function (e, i) {
        ...
        for (var a in i) {
            ...
            } else "styles" === a ? "object" === (void 0 === s ? "undefined" : Wt(s)) && Object.keys(s).map(function (t) {
                n.style[t] = s[t]
    ...
    var Vt = {
        ...
        qt = 2,
        Xt = 7,
        Jt = ["light-blue", "blue", "violet", "red", "orange", "yellow", "green", "light-green", "purple", "magenta", "light-grey", "dark-grey"],
        Kt = {
            bar: Jt,
            line: Jt,
            pie: Jt,
        ...
        Qt = function () {
            function e(t) {
                var i = t.parent,
                    ...
                    a = t.colors,
                    s = void 0 === a ? [] : a;
                Ht(this, e), this.parent = n, this.colors = s, this.titleName = "", this.titleValue = "", this.listValues = [], this.titleValueFirst = 0, this.x = 0, this.y = 0, this.top = 0, this.left = 0, this.setup()
            }
            return Ft(e, [{
                key: "setup",
                value: function () {
        ...
        ve = ".chart-container{position:relative;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI','Roboto','Oxygen','Ubuntu','Cantarell','Fira Sans','Droid Sans','Helvetica Neue',sans-serif}.chart-container .axis,.chart-container .chart-label{fill:#555b51}.chart-container .axis line,.chart-container .chart-label line{stroke:#dadada}.chart-container .dataset-units circle{stroke:#fff;stroke-width:2}.chart-container .dataset-units path{fill:none;stroke-opacity:1;stroke-width:2px}.chart-container .dataset-path{stroke-width:2px}.chart-container .path-group path{fill:none;stroke-opacity:1;stroke-width:2px}.chart-container line.dashed{stroke-dasharray:5,3}.chart-container .axis-line .specific-value{text-anchor:start}.chart-container .axis-line .y-line{text-anchor:end}.chart-container .axis-line .x-line{text-anchor:middle}.chart-container .legend-dataset-text{fill:#6c7680;font-weight:600}.graph-svg-tip{position:absolute;z-index:99999;padding:10px;font-size:12px;color:#959da5;text-align:center;background:rgba(0,0,0,.8);border-radius:3px}.graph-svg-tip ul{padding-left:0;display:flex}.graph-svg-tip ol{padding-left:0;display:flex}.graph-svg-tip ul.data-point-list li{min-width:90px;flex:1;font-weight:600}.graph-svg-tip strong{color:#dfe2e5;font-weight:600}.graph-svg-tip .svg-pointer{position:absolute;height:5px;margin:0 0 0 -5px;content:' ';border:5px solid transparent;border-top-color:rgba(0,0,0,.8)}.graph-svg-tip.comparison{padding:0;text-align:left;pointer-events:none}.graph-svg-tip.comparison .title{display:block;padding:10px;margin:0;font-weight:600;line-height:1;pointer-events:none}.graph-svg-tip.comparison ul{margin:0;white-space:nowrap;list-style:none}.graph-svg-tip.comparison li{display:inline-block;padding:5px 10px}",
        ge = function () {
            function e(t, i) {
                if (Ht(this, e), this.parent = "string" == typeof t ? document.querySelector(t) : t, !(this.parent instanceof HTMLElement)) throw new Error("No `parent` element to render on was provided.");
                ...
                }, this.measures = JSON.parse(JSON.stringify(Vt));
                var n = this.measures;
                this.setMeasures(i), this.title.length || (n.titleHeight = 0), this.config.showLegend || (n.legendHeight = 0), this.argHeight = i.height || n.baseHeight, this.state = {}, this.options = {}, this.initTimeout = Ut, this.config.isNavigable && (this.overlays = []), this.configure(i)
            }
            return Ft(e, [{
                key: "prepareData",
                value: function (t) {
                ...
                value: function (t, e) {
                    var i = [];
                    return (t = (t || []).concat(Kt[e])).forEach(function (t) {
                        var e = te(t);
                        w(e) ? i.push(e) : console.warn('"' + t + '" is not a valid color.')
                    }), i
                }
            }, {
                key: "setMeasures",
                ...
                value: function () {
                    var t = this,
                        e = this.argHeight;
                    this.baseHeight = e, this.height = e - l(this.measures), this.boundDrawFn = function () {
                        return t.draw(!0)
                ...
                value: function () {
                    ...
                    e && i(this.parent) || (this.updateWidth(), this.calc(e), this.makeChartArea(), this.setupComponents(), this.components.forEach(function (e) {
                ...
                key: "updateWidth",
                value: function () {
                    this.baseWidth = a(this.parent), this.width = this.baseWidth - u(this.measures)
                }
            }, {
                key: "makeChartArea",
                value: function () {
                    ...
                    var t = this.measures;
                    this.svg = M(this.container, "frappe-chart chart", this.baseWidth, this.baseHeight), this.svgDefs = C(this.svg), this.title.length && (this.titleEL = I("title", t.margins.left, t.margins.top, this.title, {
                        fontSize: t.titleFontSize,
                        fill: "#666666",
                        dy: t.titleFontSize
                    }));
                    var e = r(t);
                    this.drawArea = O(this.type + "-chart chart-draw-area", "translate(" + o(t) + ", " + e + ")"), this.config.showLegend && (e += this.height + t.paddings.bottom, this.legendArea = O("chart-legend", "translate(" + o(t) + ", " + e + ")")), this.title.length && this.svg.appendChild(this.titleEL), this.svg.appendChild(this.drawArea), this.config.showLegend && this.svg.appendChild(this.legendArea), this.updateTipOffset(o(t), r(t))
                }
            }, {
                key: "updateTipOffset",
                value: function (t, e) {
                ...
                value: function () {
                    ...
                    }), n.length > 0 ? (ot(this.container, this.svg, n), setTimeout(function () {
                        e.forEach(function (t) {
                            return t.make()
                        }), t.updateNav()
                ...
                value: function () {
                    ...
                    this.config.isNavigable && e && (this.bindOverlay(), this.keyActions = {
                        ...
                        n(t.container) && (e = e || window.event, t.keyActions[e.keyCode] && t.keyActions[e.keyCode]())
                    }))
                }
            }, {
                key: "makeOverlay",
                ...
                value: function () {
                    var t = ut(this.svg);
                    lt(this.title || "Chart", [t])
                }
            }]), e
        }(),
        ye = function (t) {
            function e(t, i) {
                return Ht(this, e), Rt(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, i))
            }
            return It(e, t), Ft(e, [{
                key: "configure",
                value: function (t) {
                    jt(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "configure", this).call(this, t), this.config.maxSlices = t.maxSlices || 20, this.config.maxLegendPoints = t.maxLegendPoints || 20
                }
            }, {
                key: "calc",
                value: function () {
                ...
                value: function () {
                    ...
                    this.legendTotals.map(function (a, s) {
                        var r = 150,
                            o = Math.floor((t.width - u(t.measures)) / r);
                        t.legendTotals.length < o && (r = t.width / t.legendTotals.length), i > o && (i = 0, n += 20);
                        var l = r * i + 5,
                            h = t.config.truncateLegends ? y(e.labels[s], r / 10) : e.labels[s],
                            c = j(l, n, 5, t.colors[s], h + ": " + a, !1);
                        t.legendArea.appendChild(c), i++
                    })
                }
            }]), e
        }(ge),
        ...
        Ae = function () {
            function t(e) {
                var i = e.layerClass,
                    ...
                    l = e.makeElements,
                    u = e.animateElements;
                Ht(this, t), this.layerTransform = s, this.constants = r, this.makeElements = l, this.getData = o, this.animateElements = u, this.store = [], this.labels = [], this.layerClass = n, this.layerClass = "function" == typeof this.layerClass ? this.layerClass() : this.layerClass, this.refresh()
            }
            return Ft(t, [{
                key: "refresh",
                value: function (t) {
                ...
                key: "setup",
                value: function (t) {
                    this.layer = O(this.layerClass, this.layerTransform, t)
                }
            }, {
                key: "make",
                value: function () {
        ...
        Pe = {
            ...
            pieSlices: {
                ...
                makeElements: function (t) {
                    return t.sliceStrings.map(function (e, i) {
                        var n = D(e, "pie-path", "none", t.colors[i]);
                        return n.style.transition = "transform .3s;", n
                    })
                },
                animateElements: function (t) {
            ...
            yAxis: {
                ...
                makeElements: function (t) {
                    ...
                    return t.positions.map(function (i, n) {
                        return B(i, t.labels[n], e.constants.width, {
            ...
            xAxis: {
                ...
                makeElements: function (t) {
                    var e = this;
                    return t.positions.map(function (i, n) {
                        return V(i, t.calcLabels[n], e.constants.height, {
                            mode: e.constants.mode,
                            pos: e.constants.pos
                        })
                    })
            ...
            yMarkers: {
                ...
                makeElements: function (t) {
                    ...
                    return t.map(function (t) {
                        return U(t.position, t.label, e.constants.width, {
            ...
            yRegions: {
                ...
                makeElements: function (t) {
                    var e = this;
                    return t.map(function (t) {
                        return G(t.startPos, t.endPos, e.constants.width, t.label, {
                            labelPos: t.options.labelPos
                        })
                    })
                },
            ...
            heatDomain: {
                ...
                makeElements: function (t) {
                    ...
                    return this.serializedSubDomains = [], t.cols.map(function (t, i) {
                        1 === i && e.labels.push(I("domain-name", l, -12, gt(n, !0).toUpperCase(), {
                            fontSize: 9
                        })), t.map(function (t, i) {
                            if (t.fill) {
                                var n = {
            ...
            barGraph: {
                ...
                makeElements: function (t) {
                    ...
                    return this.unitType = "bar", this.units = t.yPositions.map(function (i, n) {
                        return q(t.xPositions[n], i, t.barWidth, e.color, t.labels[n], n, t.offsets[n], {
                            zeroLine: t.zeroLine,
                ...
                animateElements: function (t) {
                    ...
                    return this.store.map(function (a, s) {
                        m = m.concat(tt(a, e[s], i[s], t.barWidth, n[s], {
                            zeroLine: t.zeroLine
                        }))
                    }), m
                }
            ...
            lineGraph: {
                ...
                makeElements: function (t) {
                    var e = this.constants;
                    return this.unitType = "dot", this.paths = {}, e.hideLine || (this.paths = J(t.xPositions, t.yPositions, e.color, {
                        heatline: e.heatline,
                        ...
                        return X(t.xPositions[n], i, t.radius, e.color, e.valuesOverPoints ? t.values[n] : "", n)
                ...
                animateElements: function (t) {
                    ...
                    var p = [];
                    return Object.keys(this.paths).length && (p = p.concat(it(this.paths, e, i, t.zeroLine, this.constants.spline))), this.units.length && this.units.map(function (t, n) {
                        p = p.concat(et(t, e[n], i[n]))
                    }), p
                }
            }
        },
        Le = function (t) {
            function i(t, e) {
                Ht(this, i);
                var n = Rt(this, (i.__proto__ || Object.getPrototypeOf(i)).call(this, t, e));
            ...
            return It(i, t), Ft(i, [{
                ...
                value: function (t) {
                    ...
                    i.height = i.height || 20, i.depth = i.depth || qt, e.paddings.right = 30, e.legendHeight = 60, e.baseHeight = 8 * (i.height + .5 * i.depth)
                }
            }, {
                key: "setupComponents",
                value: function () {
                ...
                value: function () {
                    var t = this;
                    jt(i.prototype.__proto__ || Object.getPrototypeOf(i.prototype), "calc", this).call(this);
                    var e = this.state;
        ...
        Te = function (t) {
            ...
            return It(i, t), Ft(i, [{
                key: "configure",
                value: function (t) {
                    jt(i.prototype.__proto__ || Object.getPrototypeOf(i.prototype), "configure", this).call(this, t), this.mouseMove = this.mouseMove.bind(this), this.mouseLeave = this.mouseLeave.bind(this), this.hoverRadio = t.hoverRadio || .1, this.config.startAngle = t.startAngle || 0, this.clockWise = t.clockWise || !1
                }
            }, {
                key: "calc",
                value: function () {
                    ...
                    e.sliceTotals.map(function (i, o) {
                        ...
                        var b = 360 === u ? S(y, m, t.center, t.radius, a, h) : N(y, m, t.center, t.radius, a, h);
                ...
                value: function (t, i, n, a) {
                    if (t) {
                        var s = this.colors[i];
                        if (n) {
                            st(t, this.calTranslateByAngle(this.state.slicesProperties[i])), t.style.fill = k(s, 50);
                            var r = e(this.svg),
                                o = a.pageX - r.left + 10,
                                l = a.pageY - r.top - 10,
                        ...
                        } else st(t, "translate3d(0,0,0)"), this.tip.hideTip(), t.style.fill = s
                    }
                }
            }, {
                key: "bindTooltip",
        ...
        Me = function (t) {
            function e(t, i) {
                Ht(this, e);
                var n = Rt(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, i));
            ...
            return It(e, t), Ft(e, [{
                ...
                value: function (t) {
                    var e = this.measures;
                    this.discreteDomains = 0 === t.discreteDomains ? 0 : 1, e.paddings.top = 36, e.paddings.bottom = 0, e.legendHeight = 24, e.baseHeight = 12 * me + l(e);
                    var i = this.data,
                        n = this.discreteDomains ? 12 : 0;
                    this.independentWidth = 12 * (pt(i.start, i.end) + n) + u(e)
                }
            }, {
                key: "updateWidth",
                value: function () {
                    ...
                    this.baseWidth = 12 * (e + t) + u(this.measures)
                }
            }, {
                key: "prepareData",
                value: function () {
                ...
                value: function () {
                    var t = this.state;
                    t.start = dt(this.data.start), t.end = dt(this.data.end), t.firstWeekStart = dt(t.start), t.noOfWeeks = pt(t.start, t.end), t.distribution = Dt(Object.values(this.data.dataPoints), 5), t.domainConfigs = this.getDomains()
                }
            }, {
                key: "setupComponents",
                value: function () {
                    ...
                    this.components = new Map(n.map(function (t, e) {
                        var i = xt.apply(void 0, Bt(t));
                        return [t[0] + "-" + e, i]
                    }));
                    var a = 0;
                    we.forEach(function (e, i) {
                        if ([1, 3, 5].includes(i)) {
                            var n = I("subdomain-name", -6, a, e, {
                                fontSize: 10,
                                dy: 8,
                                textAnchor: "end"
                            });
                ...
                value: function () {
                    ...
                    var e = 0,
                        ...
                        n = I("subdomain-name", e, 12, "Less", {
                            fontSize: 11,
                            dy: 9
                        });
                    e = 30, this.legendArea.appendChild(n), this.colors.slice(0, 5).map(function (n, a) {
                        var s = H("heatmap-legend-unit", e + 15 * a, 12, 10, i, n);
                        t.legendArea.appendChild(s)
                    });
                    var a = I("subdomain-name", e + 75 + 3, 12, "More", {
                        fontSize: 11,
                        dy: 9
                    });
                ...
                key: "getDomains",
                value: function () {
                    for (var t = this.state, e = [t.start.getMonth(), t.start.getFullYear()], i = e[0], n = e[1], a = [t.end.getMonth(), t.end.getFullYear()], s = a[0] - i + 1 + 12 * (a[1] - n), r = [], o = dt(t.start), l = 0; l < s; l++) {
                        var u = t.end;
                        if (!vt(o, t.end)) {
                            var h = [o.getMonth(), o.getFullYear()];
                            u = yt(h[0], h[1])
                        }
                        r.push(this.getDomainConfig(o, u)), bt(u, 1), o = u
                    }
                    return r
                }
            }, {
                ...
                value: function (t) {
                    ...
                    bt(e = dt(e) || yt(n, a), 1);
                    for (var o = pt(s, e), l = [], u = void 0, h = 0; h < o; h++) u = this.getCol(s, n), l.push(u), bt(s = new Date(u[me - 1].yyyyMmDd), 1);
                    return void 0 !== u[me - 1].dataValue && (bt(s, 1), l.push(this.getCol(s, n, !0))), r.cols = l, r
                }
            }, {
                key: "getCol",
                value: function (t, e) {
                    for (var i = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], n = this.state, a = dt(t), s = [], r = 0; r < me; r++, bt(a, 1)) {
                        var o = {},
                            l = a >= n.start && a <= n.end;
                        i || a.getMonth() !== e || !l ? o.yyyyMmDd = ct(a) : o = this.getSubDomainConfig(a), s.push(o)
                    }
                    return s
                }
            }, {
                ...
                value: function (t) {
                    ...
                    return {
                        yyyyMmDd: e,
                        dataValue: i || 0,
                        fill: this.colors[Nt(i, this.state.distribution)]
                    }
                }
            }]), e
        }(ge),
        Ce = function (t) {
            ...
            return It(i, t), Ft(i, [{
                ...
                key: "prepareData",
                value: function () {
                    return St(arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.data, this.type)
                }
            }, {
                key: "prepareFirstData",
                value: function () {
                    return Et(arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.data)
                }
            }, {
                key: "calc",
                value: function () {
                ...
                value: function () {
                    ...
                    t.datasetLength = e.length, t.unitWidth = this.width / t.datasetLength, t.xOffset = t.unitWidth / 2, t.xAxis = {
                        ...
                        positions: e.map(function (e, i) {
                            return h(t.xOffset + i * t.unitWidth)
                        })
                    }
                }
            }, {
                ...
                value: function (t) {
                    var e = Pt(t, arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "false"),
                        i = this.height / Mt(e),
                        n = Tt(e) * i,
                        a = this.height - Lt(e) * n;
                    this.state.yAxis = {
                        labels: e,
                ...
                value: function () {
                    ...
                    this.data.yMarkers && (this.state.yMarkers = this.data.yMarkers.map(function (e) {
                        return e.position = Ct(e.value, t.yAxis), e.options || (e.options = {}), e
                    })), this.data.yRegions && (this.state.yRegions = this.data.yRegions.map(function (e) {
                        return e.startPos = Ct(e.start, t.yAxis), e.endPos = Ct(e.end, t.yAxis), e.options || (e.options = {}), e
                    }))
                }
            }, {
                key: "getAllYValues",
                    ...
                    var t = this,
                        e = [
                            ...
                            ["xAxis", {
                                ...
                                var t = this.state;
                                return t.xAxis.calcLabels = _t(this.width, t.xAxis.labels, this.config.xIsSeries), t.xAxis
                            }.bind(this)],
                            ["yRegions", {
                                width: this.width,
                                pos: "right"
                ...
                value: function (t) {
                    var e = this.state;
                    if (e.yExtremes) {
                        var i = Ot(t, e.xAxis.positions, !0);
                        if (i >= 0) {
                ...
                value: function () {
                    ...
                    e.datasets.length > 1 && (this.legendArea.textContent = "", e.datasets.map(function (e, i) {
                        var n = F(100 * i, "0", 100, t.colors[i], e.name, t.config.truncateLegends);
                ...
                value: function () {
                    ...
                    this.overlayGuides && this.overlayGuides.forEach(function (t) {
                        ...
                        e.overlay = oe[e.type](i), t.drawArea.appendChild(e.overlay)
                    })
                }
            }, {
                ...
                value: function (t) {
                    var e = this.state;
                    (t = parseInt(t)) < 0 && (t = 0), t >= e.xAxis.labels.length && (t = e.xAxis.labels.length - 1), t !== e.currentIndex && (e.currentIndex = t, s(this.parent, "data-select", this.getDataPoint()))
                }
            }, {
                key: "addDataPoint",
                value: function (t, e) {
                    var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : this.state.datasetLength;
                    jt(i.prototype.__proto__ || Object.getPrototypeOf(i.prototype), "addDataPoint", this).call(this, t, e, n), this.data.labels.splice(n, 0, t), this.data.datasets.map(function (t, i) {
                ...
                value: function () {
                    ...
                    this.data.labels.length <= 1 || (jt(i.prototype.__proto__ || Object.getPrototypeOf(i.prototype), "removeDataPoint", this).call(this, t), this.data.labels.splice(t, 1), this.data.datasets.map(function (e) {
                        e.values.splice(t, 1)
                    }), this.update(this.data))
                }
            }, {
        ...
        Oe = function (t) {
            ...
            return It(i, t), Ft(i, [{
                key: "configure",
                value: function (t) {
                    jt(i.prototype.__proto__ || Object.getPrototypeOf(i.prototype), "configure", this).call(this, t), this.mouseMove = this.mouseMove.bind(this), this.mouseLeave = this.mouseLeave.bind(this), this.hoverRadio = t.hoverRadio || .1, this.config.startAngle = t.startAngle || 0, this.clockWise = t.clockWise || !1, this.strokeWidth = t.strokeWidth || 30
                }
            }, {
                key: "calc",
                value: function () {
                    ...
                    e.sliceTotals.map(function (i, o) {
                        var l = r,
                            ...
                            m = void 0;
                        t.init ? (y = g ? g.startPosition : f, m = g ? g.endPosition : f) : (y = f, m = v);
                        var b = 360 === u ? _(y, m, t.center, t.radius, t.clockWise, h) : E(y, m, t.center, t.radius, t.clockWise, h);
                        e.sliceStrings.push(b), e.slicesProperties.push({
                            startPosition: f,
                            endPosition: v,
                            value: i,
                ...
                value: function (t, i, n, a) {
                    if (t) {
                        var s = this.colors[i];
                        if (n) {
                            st(t, this.calTranslateByAngle(this.state.slicesProperties[i])), t.style.stroke = k(s, 50);
                            var r = e(this.svg),
                                o = a.pageX - r.left + 10,
                                l = a.pageY - r.top - 10,
                                u = (this.formatted_labels && this.formatted_labels.length > 0 ? this.formatted_labels[i] : this.state.labels[i]) + ": ",
                        ...
                        } else st(t, "translate3d(0,0,0)"), this.tip.hideTip(), t.style.stroke = s
                    }
                }
            }, {
                key: "bindTooltip",
        ...
        Ne = function t(e, i) {
            return Ht(this, t), zt(i.type, e, i)
        },
        Se = Object.freeze({
            Chart: Ne,
            PercentageChart: Le,
        ...
        Ee = {};
    return Ee.NAME = "Frappe Charts", Ee.VERSION = "1.5.2", Ee = Object.assign({}, Ee, Se)
}();
