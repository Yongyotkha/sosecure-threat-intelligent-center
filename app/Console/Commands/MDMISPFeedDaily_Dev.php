...
class MDMISPFeedDaily_Dev extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:MDMISPFeedDaily_Dev';
...
*/
    ...
    {
        $urlLimit = 3;
        $time_stamp_start = Carbon::now()->subDays(5)->format('Y-m-d');
      ...
      //  $time_stamp_end ="2021-08-21";
        $url_1 = "https://10.129.0.93/events/xml/download/null/false/null/" . $time_stamp_start . "/" . $time_stamp_end . "/";
        // $url_1 = "https://10.104.0.18/events/xml/download/null/false/null/2020-12-29/2020-12-30/";
                            ...
                            if ($EventCheck->length > 0) {
                                foreach ($EventCheck as $Event) {
                                    if($Event->nodeName == 'Event'){
                                      //Even ==============================================================
                                         $this->info("Event : ID:".$Event->getElementsByTagName('id')->item(0)->nodeValue.'|Name:'.$Event->getElementsByTagName('info')->item(0)->nodeValue);
                                      //   break;
                                       //==================================================================
                                        $item = array();
                                        try {
                                            ...
                                            foreach ($Event->getElementsByTagName('RelatedEvent') as $RelatedEvents) {
                                              //  $this->info('id:'. $RelatedEvent->getElementsByTagName('id')->item(0)->nodeValue);
                                               //print_r($RelatedEvent);
                                                ...
                                                try {
                                                                ...
                                                                if ($RelatedEventsCheck->length > 0) {
                                                                  ...
                                                                  //  echo "Start Name:--------------";
                                                                  //  echo  $RelatedEvent->getElementsByTagName('id')->item(0)->nodeValue;
                                                                  //  echo "End Name:--------------";
                                                                //   break;
                                            ...
                                            foreach ($Event->getElementsByTagName('Attribute') as $RelatedAttributes) {
                                                if($RelatedAttributes->nodeValue){
                                                    $relatedattribute[] = array(
                                                        ...
                                                        'timestamp' => $RelatedAttributes->getElementsByTagName('timestamp')->item(0)->nodeValue,
                                                    );
                                                }
