...
class TFClientTransfer_client_webdefacment_setting extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:TFClientTransfer_client_webdefacment_setting';
    protected $description = 'TFClientTransfer_client_webdefacment_setting';
    ...
    private $site_code = '';
    private $site_mode = '';
    private $insertToTB = 'fx_transaction_client_webdefacment_setting';
