...
class TFClientTransfer_client_webdefacment_data_original extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:TFClientTransfer_client_webdefacment_data_original';
    protected $description = 'TFClientTransfer_client_webdefacment_data_original';
    ...
    private $site_code = '';
    private $site_mode = '';
    private $insertToTB = 'fx_transaction_client_webdefacment_data_original';
