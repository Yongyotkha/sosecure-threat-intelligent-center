...
class MDCVEBatchJob_v2 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:MDCVEBatchJob_v2';
    ...
    public function handle()
    {
        ...
        $this->info("Saving data to MongoDB...");
...
echo "=====================Maping===================//////";
            $sql = "SELECT * FROM fx_cve_assets  where site_id =86";
...
//        $modified ='2023-11-01';
        ...
        WHERE  modified >=CURDATE() + INTERVAL -120 DAY and   namecve IN (' . "'".implode("','", $namecveList)."'" . ')';
