...
class TransactionCenterToClient_v01 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:TransactionCenterToClient_v01';
    protected $description = 'TransactionCenterToClient_v01';
    ...
    public function handle()
    {
        ...
        $data_methed_funciton['insertToTB'] ='fx_transaction_client_news';
        ...
        $data_methed_funciton['PATH_CLIENT_IP_TF_insertdata'] = $this->PATH_CLIENT.'/api/v1/clientinto-transfer/insertToNoRefWithID'.'?code='.$this->site_code;
        $data_methed_funciton['PATH_CENTER_IP_TF_updateTFBatchJob'] = $this->PATH_CENTER.'/api/v1/centerinto-transfer/updateTFBatchJob'.'?code='.$this->site_code;
        $data_methed_funciton['insertToTB'] ='fx_transaction_client_news_categories';
        array_push($data_methed_funciton_list, $data_methed_funciton);
        ...
        $data_methed_funciton['PATH_CLIENT_IP_TF_insertdata'] = $this->PATH_CLIENT.'/api/v1/clientinto-transfer/insertToNoRefWithID'.'?code='.$this->site_code;
        $data_methed_funciton['PATH_CENTER_IP_TF_updateTFBatchJob'] = $this->PATH_CENTER.'/api/v1/centerinto-transfer/updateTFBatchJob'.'?code='.$this->site_code;
        $data_methed_funciton['insertToTB'] ='fx_transaction_client_cve_assets';
        array_push($data_methed_funciton_list, $data_methed_funciton);
        ...
        $data_methed_funciton['PATH_CLIENT_IP_TF_insertdata'] = $this->PATH_CLIENT.'/api/v1/clientinto-transfer/insertToNoRefWithID'.'?code='.$this->site_code;
        $data_methed_funciton['PATH_CENTER_IP_TF_updateTFBatchJob'] = $this->PATH_CENTER.'/api/v1/centerinto-transfer/updateTFBatchJob'.'?code='.$this->site_code;
        $data_methed_funciton['insertToTB'] ='fx_transaction_client_data_datacve_mapping';
        array_push($data_methed_funciton_list, $data_methed_funciton);
        ...
        $data_methed_funciton['PATH_CLIENT_IP_TF_insertdata'] = $this->PATH_CLIENT.'/api/v1/clientinto-transfer/insertToNoRefWithID'.'?code='.$this->site_code;
        $data_methed_funciton['PATH_CENTER_IP_TF_updateTFBatchJob'] = $this->PATH_CENTER.'/api/v1/centerinto-transfer/updateTFBatchJob'.'?code='.$this->site_code;
        $data_methed_funciton['insertToTB'] ='fx_transaction_client_categories';
        array_push($data_methed_funciton_list, $data_methed_funciton);
        ...
        $data_methed_funciton['PATH_CLIENT_IP_TF_insertdata'] = $this->PATH_CLIENT.'/api/v1/clientinto-transfer/insertToNoRefWithID'.'?code='.$this->site_code;
        $data_methed_funciton['PATH_CENTER_IP_TF_updateTFBatchJob'] = $this->PATH_CENTER.'/api/v1/centerinto-transfer/updateTFBatchJob'.'?code='.$this->site_code;
        $data_methed_funciton['insertToTB'] ='fx_transaction_client_compromised_server';
        array_push($data_methed_funciton_list, $data_methed_funciton);
