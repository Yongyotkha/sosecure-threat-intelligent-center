...
class TransactionURLFeedRMFile extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:TransactionURLFeedRMFile';
     ...
     * @var string
     */
    protected $description = 'TransactionURLFeedRMFile';
    ...
    {
        $dataLeakSocial = LogURLFeed::where('type', 2)->where('status', 1)->where('transaction_status', 1)->get();
