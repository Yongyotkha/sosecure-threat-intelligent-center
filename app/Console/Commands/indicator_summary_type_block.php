...
class indicator_summary_type_block extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:indicator_summary_type_block';
     ...
     * @var string
     */
    protected $description = 'FeedMD_To_SQL_Summary ใช้สำหรับ summary type block';
