...
class Reminder extends Command
{
    ...
    public function handle()
    {
        ...
        if (settingEnabled('automatic_reminders')) {
            ...
            TaskReminderJob::dispatch()->delay(now()->addMinutes(2));
            InvoiceReminderJob::dispatch()->delay(now()->addMinutes(1));
            EstimateReminderJob::dispatch();
            ContractReminderJob::dispatch();
        }
        SetupChk::dispatch()->onQueue('low')->delay(now()->addMinutes(10));
