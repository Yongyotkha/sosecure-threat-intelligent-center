...
class TransactionCenterToClient_v02 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:TransactionCenterToClient_v02';
    protected $description = 'TransactionCenterToClient_v02';
    ...
    public function handle()
    {
        ...
        $data_methed_funciton['insertToTB'] ='fx_transaction_client_webdefacment_setting';
        ...
        $data_methed_funciton['PATH_CLIENT_IP_TF_insertdata'] = $this->PATH_CLIENT.'/api/v1/clientinto-transfer/insertToNoRefWithID'.'?code='.$this->site_code;
        $data_methed_funciton['PATH_CENTER_IP_TF_updateTFBatchJob'] = $this->PATH_CENTER.'/api/v1/centerinto-transfer/updateTFBatchJob'.'?code='.$this->site_code;
        $data_methed_funciton['insertToTB'] ='fx_transaction_client_webdefacment_data_original';
        array_push($data_methed_funciton_list, $data_methed_funciton);
        ...
        $data_methed_funciton['PATH_CLIENT_IP_TF_insertdata'] = $this->PATH_CLIENT.'/api/v1/clientinto-transfer/insertToNoRefWithID'.'?code='.$this->site_code;
        $data_methed_funciton['PATH_CENTER_IP_TF_updateTFBatchJob'] = $this->PATH_CENTER.'/api/v1/centerinto-transfer/updateTFBatchJob'.'?code='.$this->site_code;
        $data_methed_funciton['insertToTB'] ='fx_transaction_client_webdefacment_image_mark';
        array_push($data_methed_funciton_list, $data_methed_funciton);
        ...
        $data_methed_funciton['PATH_CLIENT_IP_TF_insertdata'] = $this->PATH_CLIENT.'/api/v1/clientinto-transfer/insertToNoRefWithID'.'?code='.$this->site_code;
        $data_methed_funciton['PATH_CENTER_IP_TF_updateTFBatchJob'] = $this->PATH_CENTER.'/api/v1/centerinto-transfer/updateTFBatchJob'.'?code='.$this->site_code;
        $data_methed_funciton['insertToTB'] ='fx_transaction_client_webdefacment_data_check';
        array_push($data_methed_funciton_list, $data_methed_funciton);
        ...
        $data_methed_funciton['PATH_CLIENT_IP_TF_insertdata'] = $this->PATH_CLIENT.'/api/v1/clientinto-transfer/insertToNoRefWithID'.'?code='.$this->site_code;
        $data_methed_funciton['PATH_CENTER_IP_TF_updateTFBatchJob'] = $this->PATH_CENTER.'/api/v1/centerinto-transfer/updateTFBatchJob'.'?code='.$this->site_code;
        $data_methed_funciton['insertToTB'] ='fx_transaction_client_webdefacment_data_logs';
        array_push($data_methed_funciton_list, $data_methed_funciton);
