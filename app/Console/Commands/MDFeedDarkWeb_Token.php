...
class MDFeedDarkWeb_Token extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:MDFeedDarkWeb_Token {q} {payload} {time_stamp_from} {time_stamp_to}';
     ...
     * @var string
     */
    protected $description = 'DarkWeb Feed Token';
    ...
    public function perform_query($typeSearch,$domain,$ip,$time_stamp_from,$time_stamp_to)
    {
        ...
        if (1==1) {
            ...
            try {
                //mapTypeDomain($typeSearch,$domain,$ip){
                $payload = $this->mapTypeDomain($typeSearch,$domain,$ip);
