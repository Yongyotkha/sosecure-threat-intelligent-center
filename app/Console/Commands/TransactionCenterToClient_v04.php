...
class TransactionCenterToClient_v04 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:TransactionCenterToClient_v04';
    protected $description = 'TransactionCenterToClient_v04';
