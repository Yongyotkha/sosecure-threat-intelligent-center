...
class MDMISPFeedIndicator extends Command
{
    ...
    public function handle()
    {
        ...
        //$output_filename_json = app_path()."/Console/Commands/temp/test.json";
    ...
    public function saveJson($json_o,$stamp_event_id,$stamp_indicator_id)
    {
        if(!empty($json_o["response"])){
            $loop = 0;
            $start = 21-1;
