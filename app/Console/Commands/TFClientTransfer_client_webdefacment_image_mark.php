...
class TFClientTransfer_client_webdefacment_image_mark extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:TFClientTransfer_client_webdefacment_image_mark';
    protected $description = 'TFClientTransfer_client_webdefacment_image_mark';
