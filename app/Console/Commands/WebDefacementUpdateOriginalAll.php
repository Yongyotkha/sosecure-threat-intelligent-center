...
class WebDefacementUpdateOriginalAll extends Command
{
    /**
    ...
    protected $signature = 'app:WebDefacementUpdateOriginalAll';
     ...
     * @var string
     */
    protected $description = 'WebDefacementUpdateOriginalAll';
    ...
    public function handle()
    {
     ...
     $WebdefacmentSetting_datas =  WebdefacmentSetting::where('active',1)->whereNull('deleted_at')->get();
   ...
   $result_json_e = json_encode($result2);
   echo $result_json_e;
 }
