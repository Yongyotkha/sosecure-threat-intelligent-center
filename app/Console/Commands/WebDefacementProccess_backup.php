...
class WebDefacementProccess_back extends Command
{
  /**
  ...
  protected $signature = 'app:WebDefacementProccess_back';
   ...
   * @var string
   */
  protected $description = 'WebDefacementProccess_back';
  ...
  {
    Log:info('Webdefacement process started:');
