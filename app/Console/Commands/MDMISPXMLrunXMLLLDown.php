...
class MDMISPXMLrunXMLLLDown extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:MDMISPXMLrunXMLLLDown';
    ...
    public function saveJson($stamp_event_id, $stamp_indicator_id, $json_o = null)
    {
        ...
        $dir_folder = "C:\\Users\\Non\\Desktop\\New folder (2)\\otx_export2 - Copy - Copy\\";
