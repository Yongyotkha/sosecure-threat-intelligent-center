...
{
    return json_decode(\Storage::get('version.json'), true);
}

function getLastVersion()
{
    return json_decode(\Storage::get('updates/update.json'), true);
}
...
{
    return Cache::get('calendarLocale', 'en-gb');
}

function datePickerLocale()
{
    $locale = Cache::get('datepickerLocale', 'en-GB');
    if ($locale == 'en') {
        return 'en-GB';
    }
    return $locale;
...
{
    return Cache::get('editorLocale', 'en');
}
