    ...
    <section class="hbox stretch">
        <section class="vbox">
            ...
            <header class="header panel-heading bg-white b-b b-light">
                <div class="bc-head"><?php echo trans('app.'.'news'); ?></div>    
                ...
                <button id="advance-search" class="btn btn-sm btn-<?php echo e(get_option('theme_color')); ?> pull-right">
                 ...
                 <div class="pull-right" style="margin-top: 8px; width: 300px;">
                    <select name="site" id="site" class="select2-option form-control select-site" style="min-width: 300px">
                        ...
                        <?php if($SiteSettings): ?>
                            <?php $__currentLoopData = $SiteSettings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $SiteSettings_val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($SiteSettings_val->code); ?>"><?php echo e($SiteSettings_val->name); ?></option>
                                    ...
                                    <div class="col-sm-9 col-xs-12">
                                        <select id="news_category" class="select2-option form-control">
                                            ...
                                            <?php $__currentLoopData = @$Category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($cate->code); ?>" ><?php echo e($cate->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
