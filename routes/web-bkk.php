...
Route::any('/misp-feed/data.csv', 'SearchController@provideCSVFeed')->name('search.provideCSVFeed');
Route::any('/misp-feed/show-data.csv', 'SearchController@ShopprovideCSVFeed')->name('search.ShopprovideCSVFeed');

Route::get('/feed/blacklist/sslblacklist.csv', 'SearchController@sslBlacklist')->name('search.sslBlacklist');
Route::get('/feed/blacklist/sha256MalwareList.csv', 'SearchController@sha256MalwareList')->name('search.sha256MalwareList');
Route::get('/feed/blacklist/md5.csv', 'SearchController@threatFoxMd5List')->name('search.threatFoxMd5List');
//sha256MalwareList
