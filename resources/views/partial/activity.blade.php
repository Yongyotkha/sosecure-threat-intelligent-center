                    ...
                    <div class="media-body">
                      ...
                      <div class="comment">
                        <span class="description small">
                          @langactivity($activity->action, ['value1' => '<span class="text-success">'.$activity->value1.'</span>', 'value2' => '<span class="text-info">'.$activity->value2.'</span>'])
                          <br><span class="text-muted">@icon('solid/clock') {{  dateTimeFormatted($activity->created_at)  }} - {{ $activity->user->name  }}</span>
                        </span>
                      </div>
                    </div>
                  </p>
