<aside class="bg-<?php echo e(get_option('sidebar_theme')); ?> aside-md b-r <?php echo e(settingEnabled('hide_sidebar') ? 'nav-xs' : ''); ?> hidden-print hidden-xs" id="nav">
    <section class="vbox">
        ...
        <header class="header bg-dark text-center clearfix">
            ...
            <div class="btn-group">
                <button type="button" class="btn btn-sm btn-<?php echo e(get_option('theme_color')); ?>" title="Language"><?php echo e(svg_image('solid/lightbulb')); ?></button>
                <div class="btn-group hidden-nav-xs">
                  <button type="button" class="btn btn-sm btn-<?php echo e(get_option('theme_color')); ?> dropdown-toggle" data-toggle="dropdown">
                  ...
                  <ul class="dropdown-menu text-left">
                    <li>
                        ...
                        <a href="<?php echo e(route('invite')); ?>" data-toggle="ajaxModal"><?php echo e(svg_image('solid/envelope-open', 'text-muted')); ?> <?php echo trans('app.'.'send_invite'); ?></a>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('projects_create')): ?>
                        <a href="<?php echo e(route('projects.create')); ?>"><?php echo e(svg_image('solid/play', 'text-muted')); ?> <?php echo trans('app.'.'start_project'); ?></a>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('contracts_create')): ?>
                        <a href="<?php echo e(route('contracts.create')); ?>"><?php echo e(svg_image('solid/file-contract', 'text-muted')); ?> <?php echo trans('app.'.'start_contract'); ?></a>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('tickets_create')): ?>
                        <a href="<?php echo e(route('tickets.create')); ?>"><?php echo e(svg_image('solid/life-ring', 'text-muted')); ?> <?php echo trans('app.'.'new_ticket'); ?></a>
                        <?php endif; ?>
        ...
        <footer class="footer lt hidden-xs b-t b-dark" id="changeLanguages">
            ...
            <div class="btn-group dropup pull-right">
                    ...
                    <li class="">
                        <a href="<?php echo e(route('setLanguage', ['lang' => $lang['code']])); ?>" title="<?php echo e(ucwords(str_replace('_', ' ', $lang['name']))); ?>">
