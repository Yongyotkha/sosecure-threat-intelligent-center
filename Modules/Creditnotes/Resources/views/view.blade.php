        ...
        <aside>
            ...
            <section class="vbox">
                <header class="header bg-white b-b clearfix hidden-print">
                    <div class="row m-t-sm">
                        ...
                        @can('credits_update')
                                ...
                                <a href="{{  route('items.insert', ['id' => $creditnote->id, 'module' => 'creditnotes'])  }}"
                                   title="@langapp('item_quick_add')  "
                        ...
                        @if ($creditnote->company->email)
                                <a href="{{ route('creditnotes.send', ['id' => $creditnote->id]) }}" data-toggle="ajaxModal"
                                   ...
                                   title="@langapp('email')  ">@icon('solid/paper-plane')</a>
                        @endif
                        @endcan
                ...
                @endif
                        ...
                        @php $showtax = get_option('show_creditnote_tax') == 'TRUE' ? true : false; @endphp
                        <div class="line"></div>
