    ...
    public function tableData()
    {
        ...
        return DataTables::eloquent($model)
            ...
            ->editColumn(
                'chk',
                function ($categorySettings) {
                    return '<label><input type="checkbox" name="checked" class="categorySettings_id" value="' . $categorySettings->id . '"><span class="label-text"></span></label>';
                }
            )
            ->editColumn(
                'name',
            ...
            ->editColumn(
                ...
                function ($categorySettings) {
                    ...
                    $html .= "<!--<a href='' class='btn btn-". get_option('theme_color') ." btn-xs' data-toggle='ajaxModal'>
                                ...
                                <a href='". route('categorysettings.delete', ['id' => $categorySettings->id]) ."' class='btn btn-danger btn-xs' data-toggle='ajaxModal'>
