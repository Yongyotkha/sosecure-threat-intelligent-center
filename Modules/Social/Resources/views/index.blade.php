...
<script>
    ...
    function load_more_book_mark(page){
        ...
        $.ajax({
            ...
            url: "/social/jqueryLoadMoreNewsBookmark?page=" + page,
            type: "get",
            datatype: "html",
            beforeSend: function(){
                $('.ajax-loading').show();
    ...
    function load_more(page){
        $.ajax({
            ...
            url: "/social/jqueryLoadMoreNews?page=" + page,
            type: "get",
            datatype: "html",
            beforeSend: function(){
                $('.ajax-loading').show();
    ...
    function load_more_topic(topic_id){
        ...
        $.ajax({
            ...
            url: "/social/jqueryLoadMoreNewsTopic?topic_id=" + topic_id,
            type: "get",
            datatype: "html",
            beforeSend: function(){
                $('.ajax-loading').show();
    ...
    function Bookmarks(ele, news_id){
        ...
        $.ajax({
            ...
            url: "/social/bookmark?news_id=" + news_id,
            type: "get",
            datatype: "json",
        }).done(function(data){
