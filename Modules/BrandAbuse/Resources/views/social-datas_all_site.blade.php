                    ...
                    <div class="header-flex-overflow m-t-7">
                        ...
                        <div class="ml-2 text-right">
                            ...
                            {{-- // var_dump(get_role_custom()['superadmin']);
                                ...
                                @if(TYPE_WEB == 'center')
                                    @if(@get_role_custom()['superadmin'] == 1 || @get_role_custom()['client'] != 1)
                                        <a id="btn_dataleak_feed" href="{{site_url('brandabuse/brandabusefeedsocial')}}" class="btn btn-sm btn-info m-l-xs"><span> Brand Abuse Feed</span></a>
                                    @endif
                                    @if(@get_role_custom()['client'] != 1)
                                        <a href="{{route('brandabuse.create') }}" class="btn btn-sm btn-{{ get_option('theme_color') }}" data-toggle="ajaxModal">
