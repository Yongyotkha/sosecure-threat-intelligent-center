                ...
                <header class="header panel-heading bg-white b-b b-light bar-header-overflow">
                    <div class="header-flex-overflow m-t-10">
                        <div class="fwb-16">
                            ...
                            <a href="{{ url('/brandabuse') }}" class="btn btn-info btn-sm btn-responsive m-r-5"><svg class="svg-inline--fa" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M257.5 445.1l-22.2 22.2c-9.4 9.4-24.6 9.4-33.9 0L7 273c-9.4-9.4-9.4-24.6 0-33.9L201.4 44.7c9.4-9.4 24.6-9.4 33.9 0l22.2 22.2c9.5 9.5 9.3 25-.4 34.3L136.6 216H424c13.3 0 24 10.7 24 24v32c0 13.3-10.7 24-24 24H136.6l120.5 114.8c9.8 9.3 10 24.8.4 34.3z"></path></svg></a>
                            @endif
                            <span>
                                Brand Abuse Feed
                            </span>
                ...
                <section class="scrollable wrapper">
                    ...
                    <section class="panel panel-default">
                        <header class="panel-heading font-bold panel-header-blue">
                            <div class="row">
                                <div class="col-xs-12">
                                    <i class="fas fa-table"></i> Table Brand Abuse Feed
                                </div>
                            </div>
                        </header>
...
<script>
    ...
    function table_social_data(){
        ...
        $('#table_data_feed').DataTable({
            ...
            ajax: {
                url: '{!! route('brandabusefeed.brandabusefeedsocial_datatables') !!}',
                data: {
    ...
    function confirm_approve(mode){
        ...
        $.ajax({
            type:"POST",
            url:"{{ route('brandabusefeed.approve_data_feed') }}",
            data:{
                id: data_feed_id,
                sent_mail: sent_mail
            },
    ...
    function confirm_cancle(){
        ...
        $.ajax({
            type:"POST",
            url:"{{ route('brandabusefeed.cancle_data_feed') }}",
