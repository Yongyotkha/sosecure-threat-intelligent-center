<div class="modal-dialog modal-dialog-aside">
    <div class="modal-content">
        <div class="modal-header bg-danger">
            ...
            <h4 class="modal-title">@langapp('delete')   {{  $ai_intel->title  }}</h4>
        </div>

        {!! Form::open(['route' => ['rssfeedsettings.ai_intel_delete_process', $ai_intel->code], 'class' => 'ajaxifyForm_custom', 'method' => 'DELETE']) !!}

        <div class="modal-body">
            <p class="text-danger">@langapp('delete_warning')  </p>

            <input type="hidden" name="checked[]" value="{{  $ai_intel->id  }}">
