<div class="modal-dialog modal-dialog-aside">
    <div class="modal-content">
        ...
        {!! Form::open(['route' => 'expenses.category.save', 'class' => 'bs-example form-horizontal', 'id' => 'saveCategory']) !!}
        ...
        <div class="modal-body">
            ...
            <ul class="list-group gutter list-group-lg list-group-sp sortable" id="categoryList">
                ...
                <li class="list-group-item" draggable="true" id="cat-{{ $category->id }}">
                    ...
                    <a href="{{ route('expenses.category.edit', ['id' => $category->id]) }}" data-toggle="ajaxModal" data-dismiss="modal">
...
@push('pagescript')
    ...
    $('#saveCategory').on('submit', function(e) {
        ...
        axios.post('{{ route('expenses.category.save') }}', data)
    ...
    $('.modal-body').on('click', '.deleteCategory', function (e) {
        ...
        axios.delete('/expenses/delete-category/' + id, {
            "id": id
        })
          .then(function (response) {
                toastr.info( response.data.message , '@langapp('response_status')');
