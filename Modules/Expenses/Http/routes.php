...
Route::group(
    ['middleware' => 'web', 'prefix' => 'expenses', 'namespace' => 'Modules\Expenses\Http\Controllers'], function () {
        ...
        Route::delete('delete-category/{id}', 'SetupController@destroyCategory')->name('expenses.category.destroy');
