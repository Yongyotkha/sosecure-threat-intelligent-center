<div class="modal-dialog modal-dialog-aside">
    ...
    {!! Form::open(['route' => ['dataleak.activity_save'], 'class' => 'ajaxifyForm_custom', 'files' => false]) !!}
        <div class="modal-body">
            ...
            <input type="hidden" name="code_edited_activity" id="id_edited_active" class="form-control" value="">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                    <input type="text" name="title" id="texttitle_new" class="form-control texttitle" value="">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-lg-3 control-label">Content</label>
                <div class="col-lg-9" >
                    <textarea  class="form-control htmleditor texteditor" id="textcontent_new" name="content"  data-id="1"  >
                    </textarea>
                </div>
            </div>
                                ...
                                <div>
                                    ...
                                    @if(TYPE_WEB == 'center')
                                        <span class="float-right">
                                            <a href="#gototop" class="btn btn-info btn-xs" onclick="edit_activity('{{addslashes($value->id)}}','{{addslashes($value->title)}}','{{addslashes($value->content)}}');">
                                                <svg class='svg-inline--fa' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'><path d='M497.9 142.1l-46.1 46.1c-4.7 4.7-12.3 4.7-17 0l-111-111c-4.7-4.7-4.7-12.3 0-17l46.1-46.1c18.7-18.7 49.1-18.7 67.9 0l60.1 60.1c18.8 18.7 18.8 49.1 0 67.9zM284.2 99.8L21.6 362.4.4 483.9c-2.9 16.4 11.4 30.6 27.8 27.8l121.5-21.3 262.6-262.6c4.7-4.7 4.7-12.3 0-17l-111-111c-4.8-4.7-12.4-4.7-17.1 0zM124.1 339.9c-5.5-5.5-5.5-14.3 0-19.8l154-154c5.5-5.5 14.3-5.5 19.8 0s5.5 14.3 0 19.8l-154 154c-5.5 5.5-14.3 5.5-19.8 0zM88 424h48v36.3l-64.5 11.3-31.1-31.1L51.7 376H88v48z'></path></svg>
                                            </a>
                                            <a href="javascript:void(0)" class="btn btn-danger btn-xs" id="asdas" onclick="delete_activity('{{addslashes($value->code)}}');"><i class="fas fa-trash-alt"></i></a>
                                        </span>
                                    @endif
...
<script>
    ...
    function add_activity(){
        ...
        $("#check_active").val("1");
        $("#id_edited_active").val('');
    }

    function edit_activity(id_activity,title_activity,content_activity){
        $("#texttitle_new").val(title_activity);
        $('#textcontent_new').summernote('code',content_activity);
        $("#check_active").val("2");
        $("#id_edited_active").val(id_activity);
    }
