<div class="modal-dialog modal-dialog-aside">
    <div class="modal-content">
        <div class="modal-header bg-blue">
            ...
            <h4 class="modal-title text-white"><i class="fas fa-compress fullscreen-btn" onclick="fullscreen();" datdata-rel="tooltip" title="Fullscreen" data-placement="right"></i> Add Compromise</h4>
        </div>
    {!! Form::open(['route' => ['compromise.add_compromise'], 'class' => 'ajaxifyForm_custom', 'files' => false]) !!}
