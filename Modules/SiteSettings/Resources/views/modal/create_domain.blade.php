<div class="modal-dialog modal-dialog-aside">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group row">
                <label class="col-lg-2 control-label">Domain <span class="text-danger">*</span> </label>
                <div class="col-lg-10">
            ...
            <div class="form-group row" style="display: none;">
                <label class="col-lg-2 control-label">Open Scan </label>
                <div class="col-lg-10">
                    <label class="switch">
            ...
            <div class="form-group row" style="display: none;">
                <label class="col-lg-2 control-label">Scan Interval <span class="text-danger">*</span> </label>
                <div class="col-lg-10">
