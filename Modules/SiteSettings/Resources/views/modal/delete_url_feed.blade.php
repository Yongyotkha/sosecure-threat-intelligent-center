<div class="modal-dialog modal-dialog-aside">
    <div class="modal-content">
        <div class="modal-header bg-danger">
            ...
            <h4 class="modal-title">@langapp('delete')   {{  $query->name  }}</h4>
        </div>

        {!! Form::open(['route' => ['urlfeed.delete_url_feed', $query->code], 'class' => 'url_feed_ajaxifyForm_custom', 'method' => 'get']) !!}

        <div class="modal-body">
            <p class="text-danger">@langapp('delete_warning')  </p>

            <input type="hidden" name="hd_code" value="{{  $query->code  }}">
...
<script>
    ...
    $('.url_feed_ajaxifyForm_custom').submit(function (event) {
