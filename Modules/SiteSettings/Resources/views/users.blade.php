        ...
        <aside>
            <section class="vbox">
                <header class="header panel-heading bg-white b-b b-light">
                    ...
                    <div class="bc-head">Site Setting &gt; Users &gt; {{ $siteSettings->name }}</div>
                    ...
                    <a href="{{route('user.create', $siteSettings->code) }}" class="btn btn-sm btn-{{ get_option('theme_color') }} pull-right" data-toggle="ajaxModal">@icon('solid/plus') @langapp('add')</a>
