                ...
                <section class="scrollable wrapper">                   
                    <section class="panel panel-default">
                        <header class="panel-heading font-bold panel-header-blue">
                            <div class="row">
                                <div class="col-xs-12">
                                    <i class="fas fa-table"></i> Table Data Leak URL
                                </div>
                            </div>
                        </header>
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                <div style="width: 100%">
                                    <table id="tbl_dataleak_url" class="table table-borered table-striped">
                                        <thead>
                                            <tr>
                                                <th class="no-sort">
                                                    <label>
    ...
    <div class="modal fade fixed-left" id="modal_data_leak_url" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-aside" role="document">
            <div class="modal-content">
                ...
                {!! Form::open(['class' => 'ajaxifyForm_custom', 'method' => 'POST']) !!}
