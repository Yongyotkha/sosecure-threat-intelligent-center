...
class DefacementController extends Controller
{
    /**
     * Item Model
     *
   ...
   // return DataTables::of($response)->make(true);
    ...
    public function dfm_feed_datatables(Request $request)
    {
    ...
    public function dfm_feed_approve_data_feed(Request $request)
    {
    ...
    public function dfm_feed_cancle_data_feed(Request $request)
    {
        $DataLeakFeedTemps = DataLeakFeedTemp::whereIn('id', $request->id)->get();
        foreach ($DataLeakFeedTemps as $DataLeakFeedTemp) {
            $DataLeakFeeds = DataLeakFeed::where('temp_id', $DataLeakFeedTemp->id)->get();
    ...
    public function dfm_feed_darkweb_all_site_tb(Request $request)
    {
    ...
    public function dfm_feed_change_status(Request $request)
    {
        // dd($request->id);
    ...
    public function dfm_feed_delete_select(Request $request)
    {
        $code_site = SiteSettings::where("id", '=', $request->site_id)->first();
    ...
    public function delete_dfm_feed_modal($code)
    {
    ...
    public function delete_dfm_feed_process($code)
    {
    ...
    public function dfm_web_server($code)
    {
        $get_data = $this->siteSettings->get_data($code);
        $data['siteSettings'] = $get_data;
        $siteID = siteSettings::where('code', $code)->first();
        ...
        $data['DataLeakSocial'] = $DataLeakSocial;
        $data['siteID'] = $siteID->id;
        $data['page'] = 'DFM_Web Server';

        $data['Credentials'] = Credentials::where('site_id',$get_data->id)->get();

        return view('sitesettings::dfm_web_server')->with($data);
    }
    ...
    public function web_server_delete(Request $request)
    {
        ...
        return ajaxResponse(
            [
                'message' => langapp('changes_saved_successful'),
                'redirect' => route('dfm_web_server.index', ['code' => $code_site->code]),
            ],
            true,
            Response::HTTP_OK
        );
