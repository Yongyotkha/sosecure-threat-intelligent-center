...
class DataLeakController extends Controller
{
    ...
    {
        $data["code"] = $code;
        $model = DataLeakSocialRef::select('data_leak_feed.feedcontent')->join(
            'data_leak_feed',
            'data_leak_feed.id',
            '=',
            'data_leak_socail_ref.data_leak_feed_id'
    ...
    {
        $data["code"] = $code;
        $model1 = DataLeakSocialRef::select('data_leak_feed.feedcontent')->join(
            'data_leak_feed',
            'data_leak_feed.id',
            '=',
            'data_leak_socail_ref.data_leak_feed_id'
