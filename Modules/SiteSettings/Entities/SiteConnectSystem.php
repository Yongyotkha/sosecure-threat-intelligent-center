...
namespace Modules\SiteConnectSystem\Entities;
...
class SiteConnectSystem extends Authenticatable implements HasLocalePreference//extends Model
{
    ...
    protected $table = "site_connect_system";
    public $timestamps = true;
    protected $fillable = [
        'id','key', 'name', 'value', 'created_by', 'updated_by',
    ];
