        ...
        <header class="header bg-white b-b clearfix hidden-print">
            <div class="row m-t-sm">
                <div class="col-md-8 m-b-xs">
                    ...
                    <a class="btn btn-sm btn-{{ get_option('theme_color') }}" data-toggle="ajaxModal" href="{{  route('items.insert', ['id' => $estimate->id, 'module' => 'estimates'])  }}" data-rel="tooltip"  data-placement="bottom" title="From Templates">
                        @icon('solid/list')
                        @langapp('items')  
                    </a>
                    @endcan
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            @can('estimates_send')
                            <li>
                                <a data-toggle="ajaxModal" href="{{ route('estimates.send', ['id' => $estimate->id]) }}">
                                    @langapp('send')  
                                </a>
                            </li>
                            @endif
                ...
                <table class="table sorted_table small" id="est-details" type="estimates">
                    <thead>
                        <tr class="est-text est-bg text-uc">
                            ...
                            <th width="25%">@langapp('description')  </th>
                    ...
                    <tbody>
                        ...
                        <div class="ajaxTotals">
                            <tr>
                                <td class="text-right no-border" colspan="{{  $showtax ? '7' : '5'  }}">
                                    <strong>
                                    @langapp('sub_total')  
                                    </strong>
                                </td>
