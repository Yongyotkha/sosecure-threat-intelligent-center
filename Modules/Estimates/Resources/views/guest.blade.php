                    ...
                    <section id="content" class="details-page public-page">
                        ...
                        @endforeach
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">{{  formatCurrency($estimate->currency, $estimate->tax1_amount)  }}</td>
                                            </tr>
                                            @endif
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">{{  formatCurrency($estimate->currency, $estimate->tax2_amount)  }}</td>
                                            </tr>
                                            @endif
