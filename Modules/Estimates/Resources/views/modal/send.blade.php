        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <label class="">@langapp('subject') @required</label>
                    <input type="text" class="form-control" value="@langmail('estimates.sending.subject', ['company' => get_option('company_name'), 'estimate' => $estimate->reference_no])" name="subject">
            </div>
