    ...
    <div class="wdfm-card">
        <div class="wdfm-header">
            <div class="wdfm-img">
                ...
                <a href="{{ config('app.URL_CENTER_PUBLISH') . $key->image_last }}" data-lightbox="name-img-2">
                    <img src="{{ config('app.URL_CENTER_PUBLISH') . $key->image_last }}"
        ...
        <div class="wdfm-body">
            <div class="wdfm-btn">
                <a href="{{ route('webdefacement.detail', ['code' => $key->code]) }}"
                    class="btn btn-icon btn-default btn-sm" data-rel="tooltip" title="View">
        ...
        <div class="wdfm-footer">
            <div class="wdfm-ft-left flex" style="width: 50%">
                ...
                <div>
                    ...
                    @if(($key->web_status ?? '') == 'Up')
                        <span class="badge bg-success">Online</span>
                    @else
                        <span class="badge" style="background-color: #b93624;">Offline</span>
                    @endif
                </div>



                <div class="status-flex mr-2"><strong>Status</strong> :
                    {!! get_webdefacment_status($key->status_val, 'color') !!}
                </div>
        ...
        <div class="wdfm-footer-action">
            <div style="display: flex;justify-content:center;">
                <a href="{{ $url }}/webdefacement/detail/{{ $key->code }}" class="btn btn-info btn-sm">
                ...
                @if(@get_role_custom()['superadmin'] == 1 || @get_role_custom()['client'] == 1)
                    ...
                    <a href="#" onclick="btn_click_del_webdefacement({{ $key->id }})"
                        class="btn btn-danger btn-sm btn_del_webdefacment">
