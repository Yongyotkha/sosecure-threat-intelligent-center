            ...
            <section class="panel panel-default">
                ...
                <div class="panel-body" id="wdfm-analytics">
                    ...
                    <div class="wrapper-circle">
                        ...
                        <div>
                            <div class="c100 p{{@$webdefacment_data_check->image_percent}} warning">
                                <!-- <span>60%</span> -->
                                <span>{{@$webdefacment_data_check->image_percent}}%</span>
                                <div class="slice">
                                  <div class="bar"></div>
                                  <div class="fill"></div>
                                </div>
                        ...
                        <div>
                            <div class="c100 p{{@$webdefacment_data_check->keyword_percent}} danger">
                                <!-- <span>90%</span> -->
                                <span>{{@$webdefacment_data_check->keyword_percent}}%</span>
                                <div class="slice">
                                  <div class="bar"></div>
                                  <div class="fill"></div>
                                </div>
