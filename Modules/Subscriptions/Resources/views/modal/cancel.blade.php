<div class="modal-dialog modal-dialog-aside">
    <div class="modal-content">
        ...
        {!! Form::open(['route' => ['subscriptions.deactivate'], 'class' => 'bs-example form-horizontal ajaxifyForm', 'data-toggle' => 'validator']) !!}
        <input type="hidden" name="id" value="{{ $subscription->id }}">
        <div class="modal-body">
            <p>You are about to cancel subscription <strong>{{ $subscription->name }}</strong> created on <strong>{{ dateTimeFormatted($subscription->created_at) }}</strong></p>
