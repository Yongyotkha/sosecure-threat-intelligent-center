...
Route::group(
    ...
    function () {
        ...
        Route::post('custom/css', 'CssController@customize')->name('settings.custom.css')->middleware('can:settings_update');
        ...
        Route::delete('stages/delete/{id}', 'StagesController@delete')->name('settings.stages.delete')->middleware('can:settings_update');
        ...
        Route::delete('sources/delete/{id}', 'SourceController@delete')->name('settings.sources.delete')->middleware('can:settings_update');
        ...
        Route::delete('pipelines/delete/{id}', 'PipelinesController@delete')->name('settings.pipelines.delete')->middleware('can:settings_update');
        ...
        Route::delete('statuses/{id}', 'StatusController@delete')->name('settings.statuses.delete')->middleware('can:settings_update');
        ...
        Route::delete('calendars/{id}', 'CalendarController@delete')->name('settings.calendars.delete')->middleware('can:settings_update');
