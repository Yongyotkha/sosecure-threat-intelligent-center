...
class Project extends Model
{
    ...
    protected $fillable = [
        ...
        'contract_id', 'billing_method', 'archived_at', 'token', 'rated', 'overbudget_at', 'feedback_disabled',
    ];
    protected $casts = [
        'settings' => 'array',
        'progress' => 'integer',
    ...
    public function codeExists($next_number)
    {
        ...
        if ($this->withTrashed()->whereCode(get_option('project_prefix') . $next_number)->count() > 0) {
