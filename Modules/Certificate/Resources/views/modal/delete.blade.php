<div class="modal-dialog modal-dialog-aside">
    <div class="modal-content">
        <div class="modal-header bg-danger">
            ...
            <h4 class="modal-title">@langapp('delete')   {{  $rssfeedsettings->name  }}</h4>
        </div>

        {!! Form::open(['route' => ['rssfeedsettings.delete_process', $rssfeedsettings->id], 'class' => 'ajaxifyForm_custom', 'method' => 'DELETE']) !!}
